...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create base Hausie assets.")
...
def main() -> None:
    ...
    with log.script("create_base"):
        ...
        if not s.HAUSIE_CLOUD_URL:
            raise RuntimeError("HAUSIE_CLOUD_URL es requerido para generar base assets en cloud.")
